...
SECRET_KEY = "django-insecure-#u1vuuz5t!f_h!-17!h$3l&1v6ko@=i!@yjn)u*v+^oc!k3k+y"
...
INSTALLED_APPS += [
    "cources_app.apps.CourcesAppConfig",
    "module_app.apps.ModuleAppConfig",
    "block_app.apps.BlockAppConfig",
